...
(function($, deck, document, undefined) {
			...
			.unbind('touchmove.deck').bind('touchmove.deck', function(e) {
				$.each(e.originalEvent.changedTouches, function(i, t) {
					if (startTouch && t.identifier === startTouch.identifier) {
						...
						if (t.screenX - startTouch.screenX > tolerance) {
							$[deck]('prev');
							startTouch = undefined;
						}
						else if (t.screenX - startTouch.screenX < -1 * tolerance) {
							$[deck]('next');
							startTouch = undefined;
						} else if (t.screenY - startTouch.screenY > tolerance){
							$[deck]('go', 'title-slide');
							startTouch = undefined;
						} else if (t.screenY - startTouch.screenY < -1 * tolerance){
							$[deck]('go', 'title-slide');
							startTouch = undefined;
						}
						return false;
	...
	*/
	$d.bind('deck.change', function(e, from, to) {
		...
		var oldFrames = $[deck]('getSlide', from).find('video, img'),
		newFrames = $[deck]('getSlide', to).find('video, img');
